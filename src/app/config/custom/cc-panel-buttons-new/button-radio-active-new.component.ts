...
@Component({
standalone: false,
  selector: "app-button-radio-active-new",
  templateUrl: "./button-radio-active-new.component.html",
  styleUrls: ["./button-radio-active-new.component.scss"],
})
export class ButtonRadioActiveNewComponent implements OnInit {
