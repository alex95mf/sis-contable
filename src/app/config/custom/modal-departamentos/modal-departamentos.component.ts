...
import { ModalDepartamentosService } from './modal-departamentos.service'; 

@Component({
standalone: false,
  selector: 'app-modal-departamentos',
  templateUrl: './modal-departamentos.component.html',
  styleUrls: ['./modal-departamentos.component.scss']
})
export class ModalDepartamentosComponent implements OnInit {
  ...
  constructor(
    ...
    private servicio: ModalDepartamentosService
  ) { 
  ...
  selectOption(dt){
    ...
    this.commonVrs.departamentoSelect.next(dt)
    this.activeModal.close()
