...
export class ListVafavorComponent implements OnInit {
  ...
  cargarDocumentos(){
    this.mensajeSppiner = "Cargando listado de valores a favor...";
  ...
  selectOption(data) {
    if (this.verifyRestore) {
      Swal.fire({
        icon: "warning",
        title: "¡Atención!",
        text: "¿Seguro que desea escoger este Valor a favor? Los campos llenados y cálculos realizados serán reiniciados.",
