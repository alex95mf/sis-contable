...
standalone: false,
  ...
  styleUrls: ['./list-garantias.component.scss']
})
export class ListGarantiasComponent implements OnInit {
  ...
  cargarDocumentos(){
    this.mensajeSppiner = "Cargando listado de garantías...";
  ...
  selectOption(data) {
    if (this.verifyRestore) {
      Swal.fire({
        icon: "warning",
        title: "¡Atención!",
        text: "¿Seguro que desea visualizar esta Garntía? Los campos llenados y cálculos realizados serán reiniciados.",
