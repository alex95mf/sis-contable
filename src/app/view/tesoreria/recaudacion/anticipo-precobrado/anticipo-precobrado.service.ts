...
export class AnticipoPrecobradoService {
  ...
  setAnticipoPrecobrado(data) {
    return this.api.apiCall("liquidacion/set-anticipo-precobrado", "POST", data);
  }
  updateAnticipoPrecobrado(data) {
    return this.api.apiCall("liquidacion/update-anticipo-precobrado", "POST", data);
  }
  getAnticipoPrecobrado(data) {
    return this.api.apiCall("liquidacion/get-anticipo-precobrado", "POST", data);
  }
