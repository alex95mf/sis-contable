...
export class ConceptoDetComponent implements OnInit {
  ...
  getDetalles() {
    ...
    if(this.concepto.concepto?.codigo == 'RP' ){
      this.apiSrv.getConceptosLiquidacionRp(data).subscribe(
        ...
        this.detalles.push({
          ...
          total:   this.concepto.liquidacion ? this.concepto.liquidacion.subtotal : this.concepto.subtotal,
          comentario:'' ,
        ...
        this.detalles.push({
          ...
          total: this.concepto.liquidacion ? this.concepto.liquidacion.subtotal_1 : this.concepto.subtotal_1,
          comentario:'' ,
          class: 'font-weight-bold'
        })
        this.detalles.push({
          ...
          total: this.concepto.liquidacion ? this.concepto.liquidacion.sta :  this.concepto.sta,
          comentario:'',
          class: ''
        })
        this.detalles.push({
          ...
          total: this.concepto.liquidacion ? this.concepto.liquidacion.subtotal_2 : this.concepto.subtotal_2,
          comentario:'' ,
          class: 'font-weight-bold'
        })
        this.detalles.push({
          ...
          total: this.concepto.liquidacion ? this.concepto.liquidacion.recargo : this.concepto.recargo,
          comentario:'' ,
          class: ''
        })
        this.detalles.push({
          ...
          total: this.concepto.liquidacion ? this.concepto.liquidacion.coactiva :  this.concepto.coactiva,
          comentario:'' ,
          class: ''
        })
        this.detalles.push({
    ...
    }else if(this.concepto.concepto?.codigo == 'TA'){
      this.apiSrv.getConceptosLiquidacionTa(data).subscribe(
        ...
        this.detalles.push({
          ...
          total:  this.concepto.liquidacion ? this.concepto.liquidacion.total :  this.concepto.total,
          comentario:'' ,
          class: 'font-weight-bold'
        })
        this.lcargando.ctlSpinner(false);
