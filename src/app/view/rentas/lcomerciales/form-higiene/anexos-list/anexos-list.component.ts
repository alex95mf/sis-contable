...
import { FormHigieneService } from '../form-higiene.service'  // Cambiar de acuerdo al modulo
...
export class AnexosListComponent implements OnInit {
  ...
  constructor(
    ...
    private apiService: FormHigieneService,
    private confirmationDialogService: ConfirmationDialogService
  ) {
    /**
     * Observador cuando se carga un Formulario de Respuesta con datos
     */
    this.commonVarService.selectInspeccionHigiene.asObservable().subscribe(
      (res) => {
     ...
     */
    this.commonVarService.updateFormularioCabHig.asObservable().subscribe(
      (res) => {
  ...
  cargaAnexo(res: any) {
    ...
    let data = {
      ...
      component: myVarGlobals.fRenFormHigiene,  // TODO: Ajustar cuando se ingrese el id del formulario
