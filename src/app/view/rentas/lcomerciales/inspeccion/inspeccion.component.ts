...
export class InspeccionComponent implements OnInit {
  ...
  async getLocales() {
    this.msgSpinner = 'Cargando Locales'
    try {
  ...
  async exportarExcel() {
    ...
    this.msgSpinner = 'Exportando Locales Comerciales'
    this.lcargando.ctlSpinner(true)
    try {
      //
   ...
   */
  viewLocal(local: any) {
    this.msgSpinner = 'Obteniendo datos de Local'
    this.lcargando.ctlSpinner(true)
  ...
  async cargaInspecciones(local: any) {
    ...
    this.msgSpinner = 'Cargando Inspecciones...';
    this.lcargando.ctlSpinner(true);
