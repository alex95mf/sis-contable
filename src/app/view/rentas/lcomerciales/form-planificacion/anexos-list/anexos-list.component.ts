...
export class AnexosListComponent implements OnInit {
  ...
  constructor(
     ...
     */
    this.commonVarService.updateFormularioCabPlanificacion.asObservable().subscribe(
      (res) => {
  ...
  cargaAnexo(res: any) {
    let data = {
      ...
      component: myVarGlobals.fRenFormPlanificacion,  // TODO: Ajustar cuando se ingrese el id del formulario
