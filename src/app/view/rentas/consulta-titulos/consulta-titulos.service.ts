...
export class ConsultaTitulosService {
  ...
  getConsultaTitulos(data: any) {
    return this.apiService.apiCall('rentas/get-consulta-titulos', 'POST', data);
  }
  
  getConsultaTitulosExcel(data: any) {
    return this.apiService.apiCall('rentas/get-consulta-titulos-excel', 'POST', data);
  }
