...
export class ContribuyenteComponent implements OnInit {
  ...
  cargarDocumentos() {
    (this as any).mensajeSpinner = "Cargando lista de documentos de pago...";
    this.lcargando.ctlSpinner(true);
  ...
  calcularTotalAnuladas() {
    (this as any).mensajeSpinner = 'Calculando total de las deudas Anuladas...';
    this.lcargando.ctlSpinner(true);
    let total = 0;
  ...
  UploadService(file, payload?: any): void {
    ...
    activarLote(data){
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          (this as any).mensajeSpinner = "Activando Lote..."
          this.lcargando.ctlSpinner(true);
    ...
    console.log(data);
        Swal.fire({
          ...
          if (result.isConfirmed) {
            (this as any).mensajeSpinner = "Inactivando Lote..."
            this.lcargando.ctlSpinner(true);
