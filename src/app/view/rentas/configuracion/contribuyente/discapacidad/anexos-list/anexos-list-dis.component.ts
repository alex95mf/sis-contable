...
export class AnexosListComponentDis implements OnInit {
    ...
    this.commonVarService.contribAnexoLoad.asObservable().subscribe(
      (res: any) => {
        ...
        let data = {
          ...
          component: myVarGlobals.fContribuyenteDiscapacidad,
          ...
          this.apiService.getAnexos(data).subscribe(
            (res: any) => {
              ...
              if(res.data.length ==0){
                this.commonVarService.diableCargarDis.next({validacion: false, anexo: this.anexos,identificador:this.identificador})
              }else{
                this.commonVarService.diableCargarDis.next({validacion: true, anexo: this.anexos ,identificador:this.identificador})
              }
  ...
  deleteSinConfirmar(anexo){
    let data = {
      ...
      id_controlador: myVarGlobals.fContribuyenteDiscapacidad,  // TODO: Actualizar cuando formulario ya tenga un ID
