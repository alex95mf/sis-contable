...
export class RetencionCompraComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.vmButtons = [
      { orig: "btnsrCompraInv", paramAccion: "", boton: { icon: "fas fa-eraser", texto: "LIMPIAR" }, permiso: true, showtxt: true, showimg: true, showbadge: false, clase: "btn btn-dark boton btn-sm", habilitar: false, imprimir: false },
