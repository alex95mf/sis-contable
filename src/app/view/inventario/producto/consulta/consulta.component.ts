...
export class ConsultaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let data = {
      id: 2,
      codigo: myVarGlobals.fConsultaProducto,
      id_rol: id_rol
    }
  ...
  savePrint() {
    let data = {
      ...
      id_controlador: myVarGlobals.fConsultaProducto
    }
        ...
        if (this.claseGlobal != "Productos" && this.claseGlobal != "Servicios") {
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              modalInvoice.componentInstance.controlador = myVarGlobals.fConsultaProducto;
