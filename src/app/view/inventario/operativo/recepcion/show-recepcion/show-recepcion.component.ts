...
@Component({
  selector: 'app-show-recepcion',
  templateUrl: './show-recepcion.component.html',
  styleUrls: ['./show-recepcion.component.scss']
})
export class ShowRecepcionComponent implements OnInit {
  ...
  constructor(
    ...
    private accSrv: RecepcionService,
  ...
  ngOnInit(): void {
    ...
    this.vmButtons = [
      { orig: "btnPedidosImpRecpe", paramAccion: "", boton: { icon: "fas fa-chevron-left", texto: "REGRESAR" }, permiso: true, showtxt: true, showimg: true, showbadge: false, clase: "btn btn-danger boton btn-sm", habilitar: false }
    ];
  ...
  recibirPedido(dt) {
    this.commonVarSrvice.listenRecetionPedidosImp.next(dt);
    this.closeModal();
  }
