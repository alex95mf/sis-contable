  ...
  getDetalles() {
    ...
    if(this.concepto.concepto?.codigo == 'RP' ){
      this.apiSrv.getConceptosLiquidacionRp(data).subscribe(
        ...
        this.detalles.push({
          concepto: {codigo_detalle: '', nombre_detalle: 'Subtotal'},
          total: this.concepto.subtotal,
          comentario:'' ,
          class: 'font-weight-bold'
        })
        this.detalles.push({
          concepto: {codigo_detalle: '', nombre_detalle: '(-) Exoneraciones'},
          total: this.concepto.exoneraciones,
          comentario:'',
          class: '' 
        })
        this.detalles.push({
          concepto: { codigo_detalle: '', nombre_detalle: 'Subtotal - Exoneraciones'},
          total: this.concepto.subtotal_1,
          comentario:'' ,
          class: 'font-weight-bold'
        })
        this.detalles.push({
          concepto: {codigo_detalle: '',nombre_detalle: '(+) STA'},
          total: this.concepto.sta,
          comentario:'',
          class: ''
        })
        this.detalles.push({
          concepto: {codigo_detalle: '',nombre_detalle: 'Subtotal + STA'},
          total: this.concepto.subtotal_2,
          comentario:'' ,
          class: 'font-weight-bold'
        })
        this.detalles.push({
          concepto: {codigo_detalle: '',nombre_detalle: '(+) Recargo'},
          total: this.concepto.recargo,
          comentario:'' ,
          class: ''
        })
        this.detalles.push({
          concepto: {codigo_detalle: '',nombre_detalle: '(+) Coactiva'},
          total: this.concepto.coactiva,
          comentario:'' ,
          class: ''
        })
        this.detalles.push({
          concepto: { codigo_detalle: '', nombre_detalle: '(+) Interés'},
          total: this.concepto.interes,
          comentario:'',
          class: '' 
        })
        this.detalles.push({
          concepto: {codigo_detalle: '',nombre_detalle: '(-) Descuento'},
          total: this.concepto.descuento,
          comentario:'',
          class: '' 
        })
        this.detalles.push({
          concepto: {codigo_detalle: '', nombre_detalle: 'Total'},
