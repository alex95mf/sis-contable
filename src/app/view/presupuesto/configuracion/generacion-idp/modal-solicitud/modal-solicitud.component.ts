...
export class ModalSolicitudComponent implements OnInit {
  ...
  constructor(
    ...
    private servicioSolicitud: GeneracionIdpService
  ) { }
  ...
  cargarSolicitudes(flag: boolean = false){
    (this as any).mensajeSpinner = "Cargando Procesos de Compras...";
  ...
  selectOption(data) {
    ...
    Swal.fire({
      icon: "warning",
      title: "¡Atención!",
      text: "¿Seguro que desea seleccionar este Proceso de Compra?",
