...
export class BandejaComponent implements OnInit {
  ...
  fTitle: string = "Bandeja de Reformas";
  reformas : any;
  vmButtons: any = [];
  dataUser: any;
  permisos: any;
  ...
  estadoNotificacionList = [
    {value: "T",label: "Todos"},
    {value: "A",label: "Por atender"},
    {value: "I",label: "Atendido"},
...
console.log(this.dataExcel)
  ...
  guardarIngresos() {
    ...
    this.apiSrv.guardarIngresosPorPeriodo(data).subscribe(
      (res:any) => {
        ...
        this.no_reforma = res['No_reforma'];
        this.fecha_ingreso = new Date(res.fecha_registro)
  ...
  anularIngresos() {
    ...
    console.log(data);
    this.apiSrv.anularIngrePorPeriodo(data).subscribe(
      res => {
        console.log(res);
        Swal.fire({
          icon: "success",
  ...
  buscarNotificaciones(){
    ...
    let data = {periodo:this.periodo,tipoReforma:this.tipoReforma,estado:this.estado, paginate: this.paginate}
    this.apiSrv.getactivenotifications(data).subscribe(
      res => {
        console.log(res);
        this.reformas = res['data'];  this.lcargando.ctlSpinner(false)
