...
export class ModalBusquedaReformaGeneralComponent implements OnInit {
  ...
  cargcarReformas() {
    (this as any).mensajeSpinner = "Cargando lista de Reformas...";
  ...
  closeModal(data?: any) {
    if (data) {
      ...
      this.commonVrs.modalReformaBusquedageneral.next(data);
    }
