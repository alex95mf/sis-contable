...
export class MetasComponent implements OnInit {
  ...
  obtenerTodasMetas() {
    ...
    this.programas = []
    this.msgSpinner = "Cargando lista de metas...";
    this.lcargando.ctlSpinner(true);
  ...
  obtenerMetas() {
    ...
    this.msgSpinner = 'Obteniendo Metas...';
    let data = {
  ...
  cargaMetaODS(event) {
    ...
    console.log(event);
    this.msgSpinner = 'Cargado Metas para ODS...';
  ...
  cargaPPG(event) {
    ...
    this.step = 5;
    this.msgSpinner = 'Cargando Politicas...';
    let data = {
      "opg": event
    };
  ...
  cargaMetaZonal(event?) {
    ...
    this.step = 6;
    this.msgSpinner = 'Cargando Metas para la Zona...';
  ...
  crearMeta() {
    ...
    // console.log(data)
    this.msgSpinner = 'Guardando Metas por Programa...';
  ...
  //     this.msgSpinner = 'Cargando Metas ODS...';
  //     this.lcargando.ctlSpinner(true);
  //     this.cuerpoMetas.meta_ods = [];
  ...
  eliminar(elem) {
    ...
    Swal.fire({
      ...
      if(result.isConfirmed) {
        this.msgSpinner = "Eliminado meta del sistema...";
        this.lcargando.ctlSpinner(true);
