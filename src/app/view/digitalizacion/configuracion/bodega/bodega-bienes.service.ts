...
export class BodegaBienesService {
  ...
  saveBodegaDig(data) {
    return this.apiService.apiCall('bodega/save-bodega-dig', 'POST', data);
  } 
  updateBodegaDig(data) {
    return this.apiService.apiCall('bodega/update-bodega-dig', 'POST', data);
  }
  getInformationDig(data) {
    return this.apiService.apiCall('bodega/get-bodegas-dig', 'POST', data);
  }
  saveEstrutureDig(data) {
    return this.apiService.apiCall('bodega/save-estructure-dig', 'POST', data);
  }
  
  updateEstrutureDig(data) {
    return this.apiService.apiCall('bodega/update-estructure-dig', 'POST', data);
  }
