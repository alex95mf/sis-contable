...
@Component({
  selector: 'app-difered-buy-prov',
  templateUrl: './difered-buy-prov.component.html',
  styleUrls: ['./difered-buy-prov.component.scss']
})
export class DiferedBuyProvComponent implements OnInit {
  ...
  async confirmSave(data) {
    Swal.fire({
      ...
      if (result.value) {
        this.commonVarServices.listenDiferedBuyProv.next(data);
        this.closeModal();
      }
    })
  }
