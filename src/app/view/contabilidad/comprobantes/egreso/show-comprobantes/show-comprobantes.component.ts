...
export class ShowComprobantesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.vmButtons = [
      { orig: "btnsLstCmpEg", paramAccion: "2", boton: { icon: "fa fa-times", texto: "CERRAR" }, permiso: true, showtxt: true, showimg: true, showbadge: false, clase: "btn btn-primary btn-sm", habilitar: false, imprimir: false}
    ];
  ...
  editarComprobante(dt) {
    this.commonVarSrvice.setVaucheresEgress.next(dt);
    this.closeModal();
  }
