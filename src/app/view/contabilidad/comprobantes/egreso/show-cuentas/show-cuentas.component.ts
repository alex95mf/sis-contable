...
export class ShowCuentasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.vmButtons = [
      { orig: "btnsLstCmpEgCta", paramAccion: "2", boton: { icon: "fa fa-times", texto: "CERRAR" }, permiso: true, showtxt: true, showimg: true, showbadge: false, clase: "btn btn-danger btn-sm", habilitar: false, imprimir: false}
    ];
  ...
  setDataAccount(dt){
    this.commonVarSrvice.setAccountComprobantes.next(dt);
    this.closeModal();
  }
}
