...
export class ModalSolicitudComponent implements OnInit {
  ...
  constructor(
    ...
    private servicioSolicitud: MultasService
  ) { }
  ...
  cargarSolicitudes(){
    (this as any).mensajeSpinner = "Cargando lista de Solicitud...";
    ...
    console.log(data);
    // this.servicioSolicitud.ListarContratos(this.proveedor.id_proveedor).subscribe(res => {
    //   console.log(res);
    //   if(res){
    //     this.solicitud = res;
    //   }
    ...
    // this.servicioSolicitud.ListarContratosCatElec(this.proveedor.id_proveedor).subscribe(res2 => {
    
    //     this.solicitud.push(res2['data'])
    
    // })
   
    if(this.tipo_proceso == 'Contratacion' || this.tipo_proceso == 'Infimas'){
