...
@Component({
  selector: 'app-retenciones-iva',
  templateUrl: './retenciones-iva.component.html',
  styleUrls: ['./retenciones-iva.component.scss']
})
export class RetencionesIvaComponent implements OnInit {
  ...
  constructor(
    private retSrv: RetencionesIvaService,
  ...
  cargarData() {
    ...
    this.retSrv.getData(data).subscribe(
      (res) => {
        console.log(res);
