...
@Component({
standalone: false,
  selector: 'app-busqueda-prestamo-salidas',
  templateUrl: './busqueda-prestamo-salidas.component.html',
  styleUrls: ['./busqueda-prestamo-salidas.component.scss']
})
export class BusquedaPrestamoSalidasComponent implements OnInit {
  ...
  constructor(
    ...
    private apiSrv: PrestamoService
  ) { }
  ...
  cargarDocumentos(flag: boolean = false){
    this.mensajeSpinner = "Cargando lista de Prestamo de Bienes...";
    ...
    this.apiSrv.getPrestamoBienesSalidaData(data).subscribe(
      (res) => {
  ...
  closeModal(data?:any) {
    if(data){
      this.commonVrs.PrestamoBienesSalidas.next(data);
    }
