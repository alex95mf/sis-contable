...
@Component({
standalone: false,
  selector: 'app-busqueda-traslado',
  templateUrl: './busqueda-traslado.component.html',
  styleUrls: ['./busqueda-traslado.component.scss']
})
export class BusquedaTrasladoComponent implements OnInit {
