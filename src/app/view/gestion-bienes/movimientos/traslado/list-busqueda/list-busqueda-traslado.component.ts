...
@Component({
standalone: false,
  selector: 'app-list-busqueda-traslado',
  templateUrl: './list-busqueda-traslado.component.html',
  styleUrls: ['./list-busqueda-traslado.component.scss']
})
export class ListBusquedaTrasladoComponent implements OnInit {
  ...
  selectOption(data: any) {
    ...
    this.apiSrv.listaBienes$.emit(data)
    this.closeModal()
    // console.log("aquii")
    // console.log(data);
