...
export class AnexosListBogComponent implements OnInit, OnDestroy {
  ...
  deleteSinConfirmar(anexo){
    let data = {
      ...
      id_controlador: myVarGlobals.fGestBienesPrestamo,  // TODO: Actualizar cuando formulario ya tenga un ID
